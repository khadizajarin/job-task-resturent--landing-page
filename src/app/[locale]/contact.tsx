...
export default function Contact() {
  ...
  return (
    <div>
    <div className={`relative h-[50rem]  text-white px-10 py-12 overflow-hidden ${poppins.className}`}>
      {/* Background image */}
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-14 h-full justify-start items-center">
        ...
        <div className="w-full h-full flex flex-col justify-evenly">
          ...
          <div>
            ...
            <ul className="text-3xl leading-normal">
        ...
        <div className={`max-w-lg h-full text-left flex flex-col justify-center`}>
          ...
          <ul className="space-y-3 text-3xl leading-snug font-medium mb-4">
    ...
    <footer className={`bg-[#c0462d] h-24 text-white flex justify-center items-center text-center py-4 shadow-md ${poppins.className}`}>
