    ...
    >
      ...
      >
        ...
        <button
          ...
          className={`block w-full text-center py-2 px-2 text-xl border-t-2 border-b-2 border-[#964315] text-[#964315] tracking-widest hover:bg-[#964315] font-black hover:text-white transition ${cinzel.className}`}
        >
          {t('reserveButton')}
        </button>
